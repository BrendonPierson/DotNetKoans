...
namespace DotNetKoans.CSharp
{
    public class AboutNil : Koan
    {
        ...
        public void YouGetNullPointerErrorsWhenCallingMethodsOnNil()
        {
            ...
            // assert something on the right throws some sort of exception on left
            // delagate is like an anonymous function
            // When throws executes delegates will execute nothing.ToString();
            // delates makes scoping different, and if we didn't use delegates, 
               // it wouldn't let us compile
